...
export const withInvestigators = ({ investigators }: IStory) => investigators.length > 0;
...
export const withReturnTo = (code: string) => (story: IStory) => story.return_to_code === code;
