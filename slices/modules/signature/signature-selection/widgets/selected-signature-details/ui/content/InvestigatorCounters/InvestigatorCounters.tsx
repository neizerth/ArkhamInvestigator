...
import {
	selectSignatureCounters,
	toggleInvestigatorCounter,
} from "@modules/signature/base/shared/lib";
import { selectCurrentSignature } from "@modules/signature/signature-selection/shared/lib";
...
export const InvestigatorCounters = (props: InvestigatorCountersProps) => {
	...
	const counterEnabled = useAppSelector(selectSignatureCounters(code));
