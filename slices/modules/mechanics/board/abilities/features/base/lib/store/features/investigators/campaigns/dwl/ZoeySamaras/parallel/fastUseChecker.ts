...
export const selecCanUseZoeySamarasFastAbility = createSelector(
	[selectChaosTokenCountByType("bless")],
	(count) => count > 2,
);

export const ParallelZoeySamarasFastAbilityChecker: AbilityChecker = {
	[AbilityCode.ZoeySamaras.parallel.fast]: selecCanUseZoeySamarasFastAbility,
};
