...
export const fullLoadTest: ChaosOddsPerformanceTestGroup = {
	id: "full",
	tokens: [
		...token({ type: "+1", value: 1, count: 3 }),
		...token({ type: "0", value: 0, count: 4 }),
		...token({ type: "-1", value: -1, count: 5 }),
		...token({ type: "-2", value: -2, count: 4 }),
		...token({ type: "-3", value: -3, count: 3 }),
		...
		...token({ type: "bless", value: 2, revealCount: 1 }),
		...token({ type: "curse", value: 2, revealCount: 1 }),
