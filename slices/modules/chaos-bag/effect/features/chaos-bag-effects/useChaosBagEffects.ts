...
import { selectChaosBagEffectModification } from "@modules/mechanics/chaos-bag/effect/entities/lib";
...
export const useChaosBagEffects = ({ boardId, tokenValues }: Options) => {
	...
	const modification = useAppSelector(
		selectChaosBagEffectModification(boardId),
	);
