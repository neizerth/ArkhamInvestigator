...
import type { HeaderLayout, PropsWithBoard } from "@pages/board/model";
...
export const BoardHeader = ({ board, layout, ...props }: BoardHeaderProps) => {
	...
	return (
		<C.Container {...props} style={[props.style, style]}>
			<C.Title board={board} layout={layout} />
			<C.Skills style={skillsStyle} layout={layout} board={board} />
		</C.Container>
	);
};
