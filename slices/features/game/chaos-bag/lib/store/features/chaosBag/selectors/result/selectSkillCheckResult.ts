...
import { selectChaosBagSkillValue } from "../../chaosBag";
import { selectRevealedTokens } from "../reveal";
import { selectDefaultTokenValuesByCode } from "../value";

export const selectSkillCheckResult = (code: string) =>
	createSelector(
		[
			selectChaosBagSkillValue,
			selectRevealedTokens,
			selectDefaultTokenValuesByCode(code),
		],
