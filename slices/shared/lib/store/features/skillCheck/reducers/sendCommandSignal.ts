import type { InvestigatorBoardStat, SkillCheckCommandType } from "@shared/model";
import type { SkillCheckReducer } from "../skillCheck.types";
import { createNumberItem, createStatItem } from "../lib";
import { last } from "ramda";


export const sendCommandSignal: SkillCheckReducer<SkillCheckCommandType> = (state, { payload }) => {
