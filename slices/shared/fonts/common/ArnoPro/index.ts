...
export const ArnoProItalic = require('./ArnoPro-Italic.otf');
export const ArnoProRegular = require('./ArnoPro-Regular.otf');


export const ArnoPro = {
  regular: 'ArnoProRegular',
  italic: 'ArnoProItalic',
  bold: 'ArnoProBold',
